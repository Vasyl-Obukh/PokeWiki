...
const { state, messageHandler, init, getTimestamp, updateState, deleteOldData } = require('./indexator');
describe('Indexator tests', () => {
    const setMock = Redis.prototype.set, delMock = Redis.prototype.del, getMock = Redis.prototype.get, postMessage = Threads.Worker.prototype.postMessage;
    afterEach(() => {
        setMock.mockReset();
        delMock.mockReset();
        getMock.mockReset();
